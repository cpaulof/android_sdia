...
public class BuildCodes {
    ...
    public static final Code VELOCITY_Y = new Code(0x64);
    public static final Code VELOCITY_Z = new Code(0x65);
    public static final Code ATTITUDE_PITCH = new Code(0x66);
